...
static ParamBlockDesc2 BerconTile_param_blk ( BerconTile_params, _M("params"),  0, &BerconTileDesc, 
	...
	tile_width2,	_M("tileWidth2"),   TYPE_FLOAT,			P_ANIMATABLE,	IDS_TILE_WIDTH2,
		p_default,		0.f,
		p_range,		0.0, 100.0f,
		p_ui, 			TYPE_SPINNER, EDITTYPE_FLOAT, IDC_TILEWIDTH_EDIT2, IDC_TILEWIDTH_SPIN2, SPIN_AUTOSCALE, 
		p_end,
	tile_height2,	_M("tileheight2"),   TYPE_FLOAT,			P_ANIMATABLE,	IDS_TILE_HEIGHT2,
		p_default,		0.f,
		p_range,		0.0, 100.0f,
		p_ui, 			TYPE_SPINNER, EDITTYPE_FLOAT, IDC_TILEHEIGHT_EDIT2, IDC_TILEHEIGHT_SPIN2, SPIN_AUTOSCALE, 
		p_end,
	edge_width2,	_M("edgeWidth2"),   TYPE_FLOAT,			P_ANIMATABLE,	IDS_TILE_EWIDTH2,
		p_default,		.0f,
		p_range,		0.0, 100.0f,
		p_ui, 			TYPE_SPINNER, EDITTYPE_FLOAT, IDC_EDGEWIDTH_EDIT2, IDC_EDGEWIDTH_SPIN2, SPIN_AUTOSCALE, 
		p_end,
	edge_height2,	_M("edgeheight2"),   TYPE_FLOAT,			P_ANIMATABLE,	IDS_TILE_EHEIGHT2,
		p_default,		.0f,
		p_range,		0.0, 100.0f,
	...
	soften,	_M("soften"),		TYPE_INT,		0,				IDS_TILE_SOFTEN,		
		p_default,		2,		
		p_ui, 			TYPE_INTLISTBOX, IDC_SOFTEN, 0, 
		p_end,	
	soften_rad,	_M("softenRad"),   TYPE_FLOAT,			P_ANIMATABLE,	IDS_TILE_SOFTRAD,
		p_default,		.1f,
		p_range,		0.0, 1000000.0f,
		p_ui, 			TYPE_SPINNER, EDITTYPE_FLOAT, IDC_SOFTENRAD_EDIT, IDC_SOFTENRAD_SPIN, SPIN_AUTOSCALE, 
		p_end,
	pb_round,	_M("pb_round"), TYPE_BOOL,			0,				IDS_TILE_ROUND,
		p_default,		TRUE,
		p_ui,			TYPE_SINGLECHEKBOX, IDC_CORNERS,
		p_end,
	round_rad,	_M("roundRad"),   TYPE_FLOAT,			P_ANIMATABLE,	IDS_TILE_ROUNDRAD,
		p_default,		.3f,
		p_range,		0.0, 1000000.0f,
	...
	// UV
	pb_auto,	_M("pb_auto"),		TYPE_INT,		0,				IDS_TILE_AUTO,		
		p_default,		5,		
		p_ui, 			TYPE_INTLISTBOX, IDC_AUTO, 0, 
		p_end,

	pb_map_uv,	_M("mapUV"), TYPE_BOOL,			0,				IDS_TILE_MAPUV,
		p_default,		TRUE,
		p_ui,			TYPE_SINGLECHEKBOX, IDC_MAPUV,
		p_end,
	pb_uv_channel,	_M("uvChannel"),   TYPE_INT,			P_ANIMATABLE,	IDS_UVWCHAN,
		p_default,		1,
		p_range,		1, 99,
	...
	pb_randX,	_M("pb_randX"),   TYPE_FLOAT,			P_ANIMATABLE,	IDS_RANDOM_X_OFF,
		p_default,		.0f,
		p_range,		0.0, 1000000.0f,
		p_ui, 			TYPE_SPINNER, EDITTYPE_FLOAT, IDC_OFF_X2, IDC_OFF_X_SPIN2, SPIN_AUTOSCALE, 
		p_end,
	pb_randY,	_M("pb_randY"),   TYPE_FLOAT,			P_ANIMATABLE,	IDS_RANDOM_Y_OFF,
		p_default,		.0f,
		p_range,		0.0f, 1000000.0f,
		p_ui, 			TYPE_SPINNER, EDITTYPE_FLOAT, IDC_OFF_Y2, IDC_OFF_Y_SPIN2, SPIN_AUTOSCALE, 
		p_end,
	pb_randSX,	_M("pb_randSX"),   TYPE_FLOAT,			P_ANIMATABLE,	IDS_RANDOM_X_SCA,
		p_default,		.0f,
		p_range,		0.0f, 1000000.0f,
		p_ui, 			TYPE_SPINNER, EDITTYPE_FLOAT, IDC_SIZ_X2, IDC_SIZ_X_SPIN2, SPIN_AUTOSCALE, 
		p_end,
	pb_randSY,	_M("pb_randSY"),   TYPE_FLOAT,			P_ANIMATABLE,	IDS_RANDOM_Y_SCA,
		p_default,		.0f,
		p_range,		0.0f, 1000000.0f,
		p_ui, 			TYPE_SPINNER, EDITTYPE_FLOAT, IDC_SIZ_Y2, IDC_SIZ_Y_SPIN2, SPIN_AUTOSCALE, 
		p_end,

	pb_lock,	_M("pb_lock"), TYPE_BOOL,			0,				IDS_LOCK_SCALE,
		p_default,		TRUE,
		p_ui,			TYPE_CHECKBUTTON, IDC_LOCK,
		p_end,

	pb_rotUV,	_M("rotUV"),		TYPE_INT,		0,				IDS_TILE_ROTUV,		
		p_default,		2,		
		p_ui, 			TYPE_INTLISTBOX, IDC_ROTUV, 0, 
		p_end,
	pb_randRot,	_M("pb_randRot"),   TYPE_FLOAT,			P_ANIMATABLE,	IDS_TILE_ROT,
		p_default,		.0f,
		p_range,		0.0f, 180.f,
	...
	pb_flipX,	_M("pb_flipX"), TYPE_BOOL,			0,				IDS_FLIP_X,
		p_default,		TRUE,
		p_ui,			TYPE_SINGLECHEKBOX, IDC_FLIPX,
		p_end,
	pb_flipY,	_M("pb_flipY"), TYPE_BOOL,			0,				IDS_FLIP_Y,
		p_default,		TRUE,
		p_ui,			TYPE_SINGLECHEKBOX, IDC_FLIPY,
		p_end,

	pb_randZ,	_M("pb_randZ"), TYPE_BOOL,			0,				IDS_SUPPORT,
		p_default,		TRUE,
		p_ui,			TYPE_SINGLECHEKBOX, IDC_RANDZ,
		p_end,	

	pb_center,	_M("pb_center"), TYPE_BOOL,			0,				IDS_CENTER_MAP,
		p_default,		TRUE,
		p_ui,			TYPE_SINGLECHEKBOX, IDC_MAPUV2,
		p_end,
	pb_center_channel,	_M("pb_center_channel"),   TYPE_INT,			P_ANIMATABLE,	IDS_UVWCHAN2,
		p_default,		1,
		p_range,		1, 99,
	...
	pb_pattern,	_M("pattern"), TYPE_STRING,			0,				IDS_PATTERN_STRING,
...
static ParamBlockDesc2 BerconMap_param_blk ( BerconMap_params, _M("params"),  0, &BerconTileDesc, 
