...
; File g:\dropbox\github\berconmaps\src\bercongradient.cpp
; File g:\dropbox\github\berconmaps\src\igradient.h
; File c:\program files\autodesk\3ds max 2019 sdk\maxsdk\include\3dsmaxdlport.h
; File g:\dropbox\github\berconmaps\src\bercongradient.cpp
; File g:\dropbox\github\berconmaps\src\igradient.h
; File g:\dropbox\github\berconmaps\src\bercongradient.cpp
...
; 416  : 			SendMessage(GetDlgItem(hWnd, IDC_GRADIENT_TYPE), CB_SETCURSEL, (WPARAM)curIndex, 0);
	...
	movsxd	rbx, DWORD PTR curIndex$18[rbp-80]
	mov	edx, 1050				; 0000041aH
	mov	rcx, r15
	call	QWORD PTR __imp_GetDlgItem
	mov	rcx, rax
...
; 432  : 			map->GetParamBlock()->GetValue(pb_type, t, curIndex, FOREVER);
	...
	mov	DWORD PTR [rsp+40], r12d
	mov	QWORD PTR [rsp+32], rax
	lea	r9, QWORD PTR curIndex$17[rbp-80]
	mov	r8d, r13d
	mov	rcx, rbx
	call	QWORD PTR [rdi+1704]
...
; 433  : 			SendMessage(GetDlgItem(hWnd, IDC_GRADIENT_TYPE), CB_SETCURSEL, (WPARAM)curIndex, 0);
	...
	movsxd	rbx, DWORD PTR curIndex$17[rbp-80]
	mov	edx, 1050				; 0000041aH
	mov	rcx, r15
	call	QWORD PTR __imp_GetDlgItem
	mov	rcx, rax
...
; 476  : 			switch (LOWORD(wParam)) {
	...
	movzx	ecx, WORD PTR wParam$[rbp-80]
...
; 478  : 					parentMap->keyNumChanged(((ISpinnerControl*)lParam)->GetIVal()); break;
	...
	mov	rcx, QWORD PTR lParam$[rbp-80]
	mov	rax, QWORD PTR [rcx]
...
; 118  : 		void SetEmpty() { start = TIME_NegInfinity; end = TIME_NegInfinity; }
	...
	mov	DWORD PTR $T1[rbp-80], -2147483648	; ffffffff80000000H
	mov	DWORD PTR $T1[rbp-76], -2147483648	; ffffffff80000000H
; File g:\dropbox\github\berconmaps\src\bercongradient.cpp
...
; 118  : 		void SetEmpty() { start = TIME_NegInfinity; end = TIME_NegInfinity; }
	...
	mov	DWORD PTR [rdi+440], -2147483648	; ffffffff80000000H
	mov	DWORD PTR [rdi+568], -2147483648	; ffffffff80000000H
	mov	DWORD PTR [rdi+572], -2147483648	; ffffffff80000000H
; File g:\dropbox\github\berconmaps\src\bercongradient.cpp
...
; 118  : 		void SetEmpty() { start = TIME_NegInfinity; end = TIME_NegInfinity; }
	...
	mov	DWORD PTR [rdi+440], -2147483648	; ffffffff80000000H
	mov	DWORD PTR [rdi+444], -2147483648	; ffffffff80000000H
; File g:\dropbox\github\berconmaps\src\bercongradient.cpp
...
; 118  : 		void SetEmpty() { start = TIME_NegInfinity; end = TIME_NegInfinity; }
	...
	mov	DWORD PTR [rcx+440], -2147483648	; ffffffff80000000H
...
; 118  : 		void SetEmpty() { start = TIME_NegInfinity; end = TIME_NegInfinity; }
	...
	mov	DWORD PTR [rbp+440], -2147483648	; ffffffff80000000H
...
; 1359 : 	if (p_disOn && p_distex) d += (1.f - p_distex->EvalMono(sc) * 2.f) * p_disStr;
	...
	vmulss	xmm0, xmm2, DWORD PTR [rbx+528]
...
; 54   : 	AColor(const AColor& c) { r = c.r; g = c.g; b = c.b; a = c.a; } 
	...
	vmovss	DWORD PTR $T3[rsp+12], xmm0
...
; 633  : 		if (p_rangeMin > p_rangeMax) // Switch so rangeMax is always bigger
	...
	vmovss	xmm0, DWORD PTR [rdi+492]
	vcomiss	xmm0, DWORD PTR [rdi+496]
...
; 118  : 		void SetEmpty() { start = TIME_NegInfinity; end = TIME_NegInfinity; }
	...
	mov	DWORD PTR [rbx+440], -2147483648	; ffffffff80000000H
	mov	DWORD PTR [rbx+444], -2147483648	; ffffffff80000000H
$LN1@resetKeys:
; File g:\dropbox\github\berconmaps\src\bercongradient.cpp
...
; 650  : 		pblockGetValue(pb_type, p_type);
	...
	lea	r12, QWORD PTR [r15+472]
	xor	ebp, ebp
	lea	rbx, QWORD PTR [r15+440]
	mov	edx, 7
	mov	DWORD PTR [rsp+40], ebp
	mov	r9, r12
...
text$x	ENDS
; Function compile flags: /Ogtp
; File c:\program files\autodesk\3ds max 2019 sdk\maxsdk\include\custcont.h
