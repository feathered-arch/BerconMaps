...
PUBLIC	??_C@_1BK@CABEKACK@?$AAC?$AAu?$AAs?$AAt?$AAG?$AAr?$AAa?$AAd?$AAi?$AAe?$AAn?$AAt?$AA?$AA@ ; `string'
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$IsolationAwareRegisterClassExW DD imagerel $LN43
	DD	imagerel $LN43+298
...
CRT$XCU	ENDS
;	COMDAT ??_C@_1BK@CABEKACK@?$AAC?$AAu?$AAs?$AAt?$AAG?$AAr?$AAa?$AAd?$AAi?$AAe?$AAn?$AAt?$AA?$AA@
CONST	SEGMENT
??_C@_1BK@CABEKACK@?$AAC?$AAu?$AAs?$AAt?$AAG?$AAr?$AAa?$AAd?$AAi?$AAe?$AAn?$AAt?$AA?$AA@ DB 'C'
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?InitGradientControls@@YAXXZ DD 021819H
	DD	03002f209H
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?GradientProc@IGradient@@SA_JPEAUHWND__@@I_K_J@Z DD 072019H
	DD	012010eH
	DD	07005e007H
	DD	050036004H
	DD	03002H
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$IsolationAwareRegisterClassExW DD 061e19H
	DD	0c640fH
	DD	0b340fH
	DD	0700b720fH
	DD	imagerel __GSHandlerCheck_SEH
	DD	01H
	DD	imagerel $LN43+185
	DD	imagerel $LN43+202
...
; 199  : 	RegisterClassEx(&wc);
	...
	lea	rax, OFFSET FLAT:??_C@_1BK@CABEKACK@?$AAC?$AAu?$AAs?$AAt?$AAG?$AAr?$AAa?$AAd?$AAi?$AAe?$AAn?$AAt?$AA?$AA@
...
; 117  : 			int sel = TrackPopupMenuEx(Popup, TPM_LEFTALIGN | TPM_RIGHTBUTTON | TPM_RETURNCMD, pt.x, pt.y, hWnd, NULL);
	...
	mov	r9d, DWORD PTR pt$2[rsp+4]
	mov	edx, 258				; 00000102H
	mov	r8d, DWORD PTR pt$2[rsp]
	mov	rcx, rbx
