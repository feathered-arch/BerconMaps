...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?reset@GradientRamp@@QEAAXXZ DD imagerel $LN30
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?getColor@GradientRamp@@QEAA?AVAColor@@M@Z DD imagerel $LN48
	DD	imagerel $LN48+276
	DD	imagerel $unwind$?getColor@GradientRamp@@QEAA?AVAColor@@M@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$4$?getColor@GradientRamp@@QEAA?AVAColor@@M@Z DD imagerel $LN48+276
	DD	imagerel $LN48+439
	DD	imagerel $chain$4$?getColor@GradientRamp@@QEAA?AVAColor@@M@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$5$?getColor@GradientRamp@@QEAA?AVAColor@@M@Z DD imagerel $LN48+439
	DD	imagerel $LN48+459
	DD	imagerel $chain$5$?getColor@GradientRamp@@QEAA?AVAColor@@M@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$?getColor@GradientRamp@@QEAA?AVAColor@@MAEAVShadeContext@@@Z DD imagerel $LN62
	DD	imagerel $LN62+116
	DD	imagerel $unwind$?getColor@GradientRamp@@QEAA?AVAColor@@MAEAVShadeContext@@@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$0$?getColor@GradientRamp@@QEAA?AVAColor@@MAEAVShadeContext@@@Z DD imagerel $LN62+116
	DD	imagerel $LN62+427
	DD	imagerel $chain$0$?getColor@GradientRamp@@QEAA?AVAColor@@MAEAVShadeContext@@@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$6$?getColor@GradientRamp@@QEAA?AVAColor@@MAEAVShadeContext@@@Z DD imagerel $LN62+427
	DD	imagerel $LN62+750
	DD	imagerel $chain$6$?getColor@GradientRamp@@QEAA?AVAColor@@MAEAVShadeContext@@@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$7$?getColor@GradientRamp@@QEAA?AVAColor@@MAEAVShadeContext@@@Z DD imagerel $LN62+750
	DD	imagerel $LN62+756
	DD	imagerel $chain$7$?getColor@GradientRamp@@QEAA?AVAColor@@MAEAVShadeContext@@@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$8$?getColor@GradientRamp@@QEAA?AVAColor@@MAEAVShadeContext@@@Z DD imagerel $LN62+756
	DD	imagerel $LN62+779
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$0$?getBump@GradientRamp@@QEAA?AVPoint3@@MV2@AEAVShadeContext@@@Z DD imagerel $LN78+134
	DD	imagerel $LN78+252
	DD	imagerel $chain$0$?getBump@GradientRamp@@QEAA?AVPoint3@@MV2@AEAVShadeContext@@@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$1$?getBump@GradientRamp@@QEAA?AVPoint3@@MV2@AEAVShadeContext@@@Z DD imagerel $LN78+252
	DD	imagerel $LN78+422
	DD	imagerel $chain$1$?getBump@GradientRamp@@QEAA?AVPoint3@@MV2@AEAVShadeContext@@@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$2$?getBump@GradientRamp@@QEAA?AVPoint3@@MV2@AEAVShadeContext@@@Z DD imagerel $LN78+422
	DD	imagerel $LN78+883
	DD	imagerel $chain$2$?getBump@GradientRamp@@QEAA?AVPoint3@@MV2@AEAVShadeContext@@@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$3$?getBump@GradientRamp@@QEAA?AVPoint3@@MV2@AEAVShadeContext@@@Z DD imagerel $LN78+883
	DD	imagerel $LN78+891
	DD	imagerel $chain$3$?getBump@GradientRamp@@QEAA?AVPoint3@@MV2@AEAVShadeContext@@@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$4$?getBump@GradientRamp@@QEAA?AVPoint3@@MV2@AEAVShadeContext@@@Z DD imagerel $LN78+891
	DD	imagerel $LN78+897
	DD	imagerel $chain$4$?getBump@GradientRamp@@QEAA?AVPoint3@@MV2@AEAVShadeContext@@@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$5$?getBump@GradientRamp@@QEAA?AVPoint3@@MV2@AEAVShadeContext@@@Z DD imagerel $LN78+897
	DD	imagerel $LN78+935
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?getColor@GradientRamp@@QEAA?AVAColor@@M@Z DD 063e01H
	DD	02883eH
	DD	0e540aH
	DD	06006920aH
xdata	ENDS
...
; 489  : 	float mult = interpolate(x, position[low], position[high]);
	...
	vmovss	xmm3, DWORD PTR [r10+r15*4]
...
$LN22@getColor:
	mov	rax, QWORD PTR [rbx+40]
	add	r15, r15
	vmovups	xmm0, XMMWORD PTR [rax+r15*8]
	vmovups	XMMWORD PTR $T1[rbp-105], xmm0
	lea	r15, QWORD PTR $T1[rbp-105]
$LN23@getColor:
	mov	rcx, QWORD PTR [rbx+24]
...
; 314  : 	return(AColor(a.r*f, a.g*f, a.b*f, a.a*f));
	...
	vmulss	xmm6, xmm9, DWORD PTR [r15+4]
	vmulss	xmm7, xmm9, DWORD PTR [r15+8]
	vmulss	xmm8, xmm9, DWORD PTR [r15+12]
	vmulss	xmm5, xmm9, DWORD PTR [r15]
...
; 313  : inline AColor operator*(const AColor& a, float f) {
